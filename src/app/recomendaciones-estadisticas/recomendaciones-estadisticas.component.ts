...
@Component({
  selector: 'app-recomendaciones-estadisticas',
  templateUrl: './recomendaciones-estadisticas.component.html',
  styleUrls: ['./recomendaciones-estadisticas.component.scss']
})
export class RecomendacionesEstadisticasComponent implements OnInit {
